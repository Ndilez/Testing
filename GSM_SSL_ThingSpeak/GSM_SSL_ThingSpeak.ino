/*
 ...
 this example performs a write and read operation to the thingspeak channel specified in the
 arduino_secrets.h file. You can Change the fields it writes to on Thingspeak as you wish
...
void loop() {
   ...
   digitalWrite(13, LOW);        // sets the digital pin 13 off
   int result = 1; //temporarily set a result manually, leter we can set the result based on a reading from a light sensor
